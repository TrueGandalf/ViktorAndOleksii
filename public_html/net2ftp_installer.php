...
elseif ($_GET["security_code"] != "ko0runc48ee4zhcpnbz7" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_sm7ol";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=ko0runc48ee4zhcpnbz7" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="31.220.16.103"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u703408236"></td></tr>
